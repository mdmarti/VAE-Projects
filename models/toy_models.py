...
def run_2d_swirly_boy():
	...
	lr = 1e-5
	model1 = nonlinearLatentSDE(dim=2,save_dir=f'/home/miles/attempt_shorterDT_2d_zscore_lr_{lr}_diag',\
			     plotDists=True,diag=False,true1=mu,true2=d)
	
	dls = makeToyDataloaders(xDownsampled,xTestDownsampled,dt=observeddt)
	model2 = nonlinearLatentSDENatParams(dim=2,save_dir=f'/home/miles/attempt_shorterDT_2d_zscore_natparms_lr_{lr}_diag',\
	...
	checkpointDir1 = f'/home/miles/attempt_2d_zscore_lr_{lr}_diag'
	checkpointDir2 = f'/home/miles/attempt_2d_zscore_natparms_lr_{lr}_diag'
